// source: query_dense_16_158.graph
...
MATCH (n0)-[r0:authored|:contains|:contributed_to]-(n1),
      ...
      (n7)-[r25:authored|:contains|:contributed_to]-(n11),
      (n7)-[r26:authored|:contains|:contributed_to]-(n12),
      (n8)-[r27:authored|:contains|:contributed_to]-(n10),
      (n8)-[r28:authored|:contains|:contributed_to]-(n11),
      ...
      (n13)-[r35:authored|:contains|:contributed_to]-(n15)
WHERE id(n0) <> id(n1)
  AND id(n0) <> id(n2)
  AND id(n0) <> id(n3)
  AND id(n0) <> id(n4)
