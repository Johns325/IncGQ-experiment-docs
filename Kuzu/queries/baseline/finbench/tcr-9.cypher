...
RETURN
  round(sum(edge1.amount) / sum(edge2.amount), 3) AS ratioRepay,
  round(sum(edge1.amount) / sum(edge4.amount), 3) AS ratioOut,
  round(sum(edge3.amount) / sum(edge4.amount), 3) AS ratioIn
